export default function Lab1() {
    ...
    <div id="wd-lab1">
        ...
        <div id="wd-images">
            ...
            <br />
            <img id="wd-teslabot" src="images/teslabot.jpg" height="200px" width="200px"/>
        </div>
        <div id="wd-forms">
            <h4>Form Elements</h4>
        ...
        <a id="wd-github" href="https://github.com/KhushiPatel09/kanbas-react-web-app">Click to navigate Github</a>
