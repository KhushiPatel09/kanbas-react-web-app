...
export default function ModulesControls() {
  return (
    <div id="wd-modules-controls" className="d-flex justify-content-end text-nowrap">
      ...
      <button id="wd-view-progress" className="btn btn-lg btn-secondary me-1" type="button">View Progress</button>
        ...
        <ul className="dropdown-menu">
          ...
          <li>
            <a id="wd-unpublish-all-modules-and-items" className="dropdown-item" href="#">
              <MdDoNotDisturbAlt className="me-1 fs-5"/> Unpublish all modules and items</a>
          </li>
          <li>
            <a id="wd-unpublish-modules-only" className="dropdown-item" href="#">
              <MdDoNotDisturbAlt className="me-1 fs-5"/> Unpublish modules only</a>
          </li>
        </ul>
      </div>
